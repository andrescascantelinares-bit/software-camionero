...
# --- 2. LOGIN MULTIUSUARIO (RESTABLECIDO) ---
...
with tabs[0]:
    with st.form("f_reg", clear_on_submit=True):
        ...
        if st.form_submit_button("SINCRONIZAR"):
            try:
                # Aquí podrías subir la foto procesada si agregás la columna a Supabase
...
with tabs[2]:
    ...
    if not df.empty:
        ...
        st.download_button("📄 PDF Reporte", pdf_b, "reporte.pdf", "application/pdf")